...
const endpointCreator: Endpoints = (
  page: number,
  perPage: number,
  search: string,
  language: string,
...
const allCoursesController = async (req: Request, res: Response) => {
  try {
    const response = await axios.get(
      endpointCreator(1, 100, "", "All", "All", "", false, false)
    );
...
const hindiController = async (req: Request, res: Response) => {
  try {
    const response = await axios.get(
      endpointCreator(1, 100, "", "Hindi", "All", "", false, false)
    );
    res.json(response.data);
  } catch (error) {
    res.json(error);
...
const commerceController = async (req: Request, res: Response) => {
  try {
    const response = await axios.get(
      endpointCreator(1, 100, "", "All", "5", "", false, false)
    );
    res.json(response.data);
  } catch (error) {
    res.json(error);
...
const artsController = async (req: Request, res: Response) => {
  try {
    const response = await axios.get(
      endpointCreator(1, 100, "", "All", "12", "", false, false)
    );
    res.json(response.data);
  } catch (error) {
    res.json(error);
...
const scienceController = async (req: Request, res: Response) => {
  try {
    const response = await axios.get(
      endpointCreator(1, 100, "", "All", "2", "", false, false)
    );
    res.json(response.data);
  } catch (error) {
    res.json(error);
